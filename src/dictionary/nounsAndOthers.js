const dict = [
    ...
    [{ 'no': 'langt', 'pl': 'daleko' }, { 'no': 'lenge', 'pl': 'długo' }, { 'no': 'lang', 'pl': 'długi' }, { 'no': 'en\\ei grunnskole', 'pl': 'szkoła podstawowa' }, { 'no': 'leder i bystret', 'pl': 'przewodniczący miasta' }, { 'no': 'en veterinare medisin student', 'pl': 'student medycyny' }, { 'no': 'din tur', 'pl': 'twoja kolej' }, { 'no': 'en/ei bygd', 'pl': 'wieś' }, { 'no': 'å fokusere på', 'pl': 'fokusować się na' }, { 'no': 'når det gjelder', 'pl': 'kiedy to dotyczy' }, { 'no': 'en undersekelse', 'pl': 'badanie przez lekarza' }, { 'no': 'en/ei forskning', 'pl': 'badanie naukowe' }, { 'no': 'a måle blodtrykk og temperatur', 'pl': 'mierzyć ciśnienie i temperaturę' }, { 'no': 'en nettside', 'pl': 'strona internetowa' }, { 'no': 'hjemmefra', 'pl': 'z domu, zdalnie' }, { 'no': 'elektroniske apparaten', 'pl': 'urządzenia elektryczne' }, { 'no': 'å savne', 'pl': 'tęsknić za' }, { 'no': 'å ble ening', 'pl': 'być zgodnym' }, { 'no': 'lystig', 'pl': 'wesoły (do osób przy opisie)' }, { 'no': 'a tjene', 'pl': 'serwować' }, { 'no': 'i bakgrunnen', 'pl': 'z tyłu' }, { 'no': 'i forgrunnen', 'pl': 'z przodu' }, { 'no': 'ved siden av', 'pl': 'obok' }, { 'no': 'på bildet', 'pl': 'na obrazku' }, { 'no': 'på en benk', 'pl': 'na ławce' }, { 'no': 'en busken', 'pl': 'krzak' }, { 'no': 'en kjaareste', 'pl': 'sympatia' }, { 'no': 'å spille sjakk', 'pl': 'grać w szachy' }, { 'no': 'en pongtong', 'pl': 'ponton' }, { 'no': 'på handkle', 'pl': 'na ręczniku' }],

    [{ 'no': '1.', 'pl': 'første' }, { 'no': '2.', 'pl': 'andre' }, { 'no': '3.', 'pl': 'tredje' }, { 'no': '4.', 'pl': 'fjerde' }, { 'no': '5.', 'pl': 'femte' }, { 'no': '6.', 'pl': 'sjette' }, { 'no': '7.', 'pl': 'sjuende (syvende)' }, { 'no': '8.', 'pl': 'åttende' }, { 'no': '9.', 'pl': 'niende' }, { 'no': '10.', 'pl': 'tiende' }, { 'no': '11.', 'pl': 'ellevte' }, { 'no': '12.', 'pl': 'tolvte' }, { 'no': '13.', 'pl': 'trettende' }, { 'no': '14.', 'pl': 'fjortende' }, { 'no': '15.', 'pl': 'femtende' }, { 'no': '16.', 'pl': 'sekstende' }, { 'no': '17.', 'pl': 'syttende' }, { 'no': '18.', 'pl': 'attende' }, { 'no': '19.', 'pl': 'nittende' }, { 'no': '20.', 'pl': 'tjuende' }, { 'no': '21.', 'pl': 'tjueførste' }, { 'no': '22.', 'pl': 'tjueandre' }, { 'no': '23.', 'pl': 'tjuetredje' }, { 'no': '24.', 'pl': 'tjuefjerde' }, { 'no': '25.', 'pl': 'tjuefemte' }, { 'no': '30.', 'pl': 'trettiende' }, { 'no': '31.', 'pl': 'trettiførste' }, { 'no': '40.', 'pl': 'førtiende' }, { 'no': '50.', 'pl': 'femtiende' }, { 'no': '60.', 'pl': 'sekstiende' }, { 'no': '70.', 'pl': 'syttiende' }, { 'no': '80.', 'pl': 'åttiende' }, { 'no': '90.', 'pl': 'nittiende' }, { 'no': '100.', 'pl': 'hundrede' }, { 'no': '200.', 'pl': 'tohundrede' }, { 'no': '240.', 'pl': 'tohundreogførtiende' }],
]

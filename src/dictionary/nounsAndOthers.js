const dict = [
    ...
    [{ 'no': 'å drive med / å holde på med', 'pl': 'zajmować się' }, { 'no': 'et besøk', 'pl': 'odwiedziny, wizyta' }, { 'no': 'et hotell', 'pl': 'hotel' }, { 'no': 'å søke', 'pl': 'poszukiwać (seek, search)' }, { 'no': 'søke på en jobb', 'pl': 'apply for a job' }, { 'no': 'søke om studielån', 'pl': 'apply for a loan for one\'s studies' }, { 'no': 'en erfaring', 'pl': 'doświadczenie (experience)' }, { 'no': 'et regnskap', 'pl': 'rachunkowość' }, { 'no': 'et firma', 'pl': 'firma' }, { 'no': 'en utfordring', 'pl': 'wyzwanie (challenge)' }, { 'no': 'å ta førerkort', 'pl': 'robić prawo jazdy' }, { 'no': 'kjøretimer', 'pl': 'kursy jazdy' }, { 'no': 'enig', 'pl': 'racja' }, { 'no': 'for en stund siden', 'pl': 'jakiś czas temu' }, { 'no': 'å sjekke', 'pl': 'sprawdzać, flirtować, czatować' }, { 'no': 'et nett', 'pl': 'sieć' }, { 'no': 'et tipse', 'pl': 'tip, wskazówka' }, { 'no': 'å savne', 'pl': 'tęsknić' }, { 'no': 'å glede seg over', 'pl': 'cieszyć się' }, { 'no': 'å glede seg til', 'pl': 'look forward to' }, { 'no': 'skål', 'pl': 'na zdrowie' }, { 'no': 'å oppfylle oppfyller oppfylte oppfylt', 'pl': 'spełniać' }, { 'no': 'søsken', 'pl': 'rodzeństwo' }, { 'no': 'en tvilling', 'pl': 'bliźniak' }, { 'no': 'en samtale', 'pl': 'rozmowa, conversation' }, { 'no': 'skilt skilte', 'pl': 'separated, divorced' }, { 'no': 'teoridelen', 'pl': 'część teoretyczna' }, { 'no': 'en prøve', 'pl': 'test, egzamin, próba' }, { 'no': 'en teoriprøve', 'pl': 'egzamin teoretyczny' }, { 'no': 'en teori', 'pl': 'teoria' }, { 'no': 'finnes', 'pl': 'znajdować się (am, are, is)' }, { 'no': 'å hilse', 'pl': 'pozdrawiać' }],
    ...
    [{ 'no': 'borte fra jobben', 'pl': 'z dala od pracy' }, { 'no': 'vondt i ryggen', 'pl': 'ból pleców' }, { 'no': 'en rygg', 'pl': 'plecy' }, { 'no': 'å klare', 'pl': 'zdołać, udać się (manage)' }, { 'no': 'en kollega', 'pl': 'kolega, współpracownik' }, { 'no': 'kollega av monica', 'pl': 'kolega moniki' }, { 'no': 'stakkars deg', 'pl': 'biedny ty (poor you)' }, { 'no': 'å føle seg', 'pl': 'czuć się' }, { 'no': 'å si fra til', 'pl': 'przekazać' }, { 'no': 'senere', 'pl': 'później' }, { 'no': 'like dårlig', 'pl': 'tak samo źle' }, { 'no': 'like', 'pl': 'just (before, after), very close (to), directly (beside)' }, { 'no': 'kaster opp', 'pl': 'wymiotować' }, { 'no': 'å ta imot', 'pl': 'otrzymać' }, { 'no': 'et emne', 'pl': 'temat' }, { 'no': 'en sykdom, sykdommen', 'pl': 'choroba' }, { 'no': 'gi beskjed', 'pl': 'dać znać' }, { 'no': 'en feber', 'pl': 'gorączka' }, { 'no': 'slik, slikt, slike', 'pl': 'taki' }, { 'no': 'det var synd', 'pl': 'szkoda' }, { 'no': 'pass på deg selv', 'pl': 'dbaj o siebie' }],
    ...
    [{ 'no': 'å skaffe seg', 'pl': 'otrzymać' }, { 'no': 'heldigvis', 'pl': 'szczęśliwie' }, { 'no': 'en måte', 'pl': 'sposób' }, { 'no': 'en vikar', 'pl': 'zastępca' }, { 'no': 'en kvalifikasjon', 'pl': 'kwalifikacja' }, { 'no': 'deretter', 'pl': 'następnie' }, { 'no': 'en stilling', 'pl': 'job, position' }, { 'no': 'slik, slikt, slike', 'pl': 'taki (such)' }, { 'no': 'offentlig', 'pl': 'publiczny' }, { 'no': 'en tjeneste', 'pl': 'usługa, praca' }, { 'no': 'en søknad', 'pl': 'formularz' }, { 'no': 'en opplysning', 'pl': 'informacja' }, { 'no': 'en annonse for ledige stillinger', 'pl': 'ogłoszenie o wolnych stanowiskach' }, { 'no': 'en instruks', 'pl': 'instrukcja' }, { 'no': 'en brann', 'pl': 'pożar' }, { 'no': 'en branninstruks', 'pl': 'instrukcja pożarowa' }, { 'no': 'en bygning', 'pl': 'budynek' }, { 'no': 'på forhånd', 'pl': 'zawczasu (in advance)' }, { 'no': 'et brannvesen', 'pl': 'straż pożarna' }, { 'no': 'et telefonnummer', 'pl': 'numer telefonu' }, { 'no': 'å trykke på', 'pl': 'nacisnąć na' }, { 'no': 'å lukke, å stenge', 'pl': 'zamknąć' }, { 'no': 'en dør', 'pl': 'drzwi' }, { 'no': 'en/ei vindu', 'pl': 'okno' }, { 'no': 'å forlate', 'pl': 'opuścić' }, { 'no': 'et samlingspunkt', 'pl': 'punk zbiórki' }, { 'no': 'straks', 'pl': 'natychmiast' }, { 'no': 'et utstyr', 'pl': 'sprzęt' }, { 'no': 'å slukke', 'pl': 'gasić' }, { 'no': 'en brannalarm', 'pl': 'alarm pożarowy' }, { 'no': 'en/ei mor, mødre, mødrene', 'pl': 'matka' }],
]

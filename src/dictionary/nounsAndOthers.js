const dict = [
    ...
    [{ 'no': 'hjemmeværende', 'pl': 'gospodynia domowa' }, { 'no': 'utenfor', 'pl': 'na zewnątrz' }, { 'no': 'å gifte seg', 'pl': 'żenić się, wyjść za mąż' }, { 'no': 'senere', 'pl': 'później' }, { 'no': 'en deltidsjobb', 'pl': 'praca na połowę/część etatu' }, { 'no': 'en assistent', 'pl': 'asystent' }, { 'no': 'å foretrekke', 'pl': 'preferować' }, { 'no': 'å drive med', 'pl': 'zajmować się' }, { 'no': 'arbeidsledig', 'pl': 'bezrobotny' }, { 'no': 'en sjåfør', 'pl': 'szofer' }, { 'no': 'å glede seg til', 'pl': 'oczekiwać (look forward to)' }, { 'no': 'da jeg kom hit til landet', 'pl': 'kiedy przybyłem tu do kraju' }, { 'no': 'en byggeplass', 'pl': 'plac budowy' }, { 'no': 'en stund', 'pl': 'chwila' }, { 'no': 'å si opp', 'pl': 'zwolnić (kogoś z pracy), powiadomić, aulować' }, { 'no': 'dessverre', 'pl': 'niestety' }, { 'no': 'heldigvis', 'pl': 'szczęśliwie' }, { 'no': 'en vikarjobb', 'pl': 'praca na zastępstwie' }, { 'no': 'å slutte på', 'pl': 'rzucić' }, { 'no': 'forskjellige', 'pl': 'różne' }, { 'no': 'hva slags jobb vil du helst ha', 'pl': 'jaki rodzaj pracy wolałbyś mieć?' }, { 'no': 'å godkjenne godkjenner godkjente godkjent', 'pl': 'zdobyć nostryfikacje' }, { 'no': 'et behov', 'pl': 'potrzeba' }, { 'no': 'et behov for', 'pl': 'potrzeba na' }, { 'no': 'å ordne', 'pl': 'zaaranżować' }, { 'no': 'godkjenning av utdanningen', 'pl': 'nostryfikacja edukacji' }, { 'no': 'foreløpig', 'pl': 'wstępne, tymczasowe, obecne' }, { 'no': 'selvstendig', 'pl': 'samodzielny' }, { 'no': 'å fornøyd med', 'pl': 'zadowolony z' }, { 'no': 'å ta seg av', 'pl': 'zajmować' }, { 'no': 'nok', 'pl': 'chyba, dość' }, { 'no': 'et lager', 'pl': 'magazyn' }, { 'no': 'en dommer', 'pl': 'sędzia' }, { 'no': 'å dømme', 'pl': 'sądzić' }, { 'no': 'farlig', 'pl': 'bezpieczny' }, { 'no': 'en bonde', 'pl': 'rolnik' }, { 'no': 'en gris', 'pl': 'świnia' }, { 'no': 'å luke', 'pl': 'pielić' }, { 'no': 'tilfredsstillende', 'pl': 'zadowalający, satysfakcjonujący' }, { 'no': 'en tømmermann', 'pl': 'drwal' }, { 'no': 'en tømmerhugger', 'pl': 'drwal' }, { 'no': 'en/ei kilde', 'pl': 'źródło, studnia' }, { 'no': 'å mate', 'pl': 'karmić' }],
]

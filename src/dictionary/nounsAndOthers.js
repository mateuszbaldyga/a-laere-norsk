const dict = [
    ...
    [{ 'no': 'omgitt av', 'pl': 'surrounded by' }, { 'no': 'selv om', 'pl': 'chociaż, mimo że' }, { 'no': 'være forberedt på', 'pl': 'być przygotowanym na' }, { 'no': 'vanntett, vanntette', 'pl': 'wodoodporny' }, { 'no': 'rund, rundt, runde', 'pl': 'okrągły' }, { 'no': 'i midten', 'pl': 'na środku' }, { 'no': 'en høyde', 'pl': 'pagórek, górka, wzniesienie' }, { 'no': 'en borg', 'pl': 'zamek' }, { 'no': 'lønnet', 'pl': 'płatny' }, { 'no': 'i retning av', 'pl': 'w kierunku' }, { 'no': 'ellers', 'pl': 'w przeciwnym razie, otherwise' }, { 'no': 'ei løype, løypa, løyper, løypene', 'pl': 'trasa, kurs, tor, szlak' }],

    [{ 'no': 'å bytte', 'pl': 'wymienić' }, { 'no': 'et bytte', 'pl': 'wymiana' }, { 'no': 'å leve', 'pl': 'żyć' }, { 'no': 'merkelig', 'pl': 'niezwykły, dziwny' }, { 'no': 'en båt', 'pl': 'łódź, statek' }, { 'no': 'en plikt', 'pl': 'obowiązek' }, { 'no': 'en/ei blodpannekake', 'pl': 'naleśnik z krwi' }, { 'no': 'en/ei reindrift', 'pl': 'hodowla reniferów' }, { 'no': 'en/er favorittmat', 'pl': 'ulubione jedzenie' }, { 'no': 'en favoritt', 'pl': 'ulubieniec' }, { 'no': 'å slakte, slakter, slaktet (el slakta), slaktet (el slakta)', 'pl': 'zabić, upolować' }, { 'no': 'å få vite', 'pl': 'get to know, dowiedzieć się' }, { 'no': 'å overleve, -lever, -levde, -levd', 'pl': 'survive' }, { 'no': 'en koffert', 'pl': 'walizka' }, { 'no': 'spent på hva som er...', 'pl': 'podekscytowany tym co jest...' }, { 'no': 'et forkle', 'pl': 'fartuch' }, { 'no': 'en dåp', 'pl': 'chrzest' }, { 'no': 'en/ei skibrille', 'pl': 'gogle narciarskie' }, { 'no': 'klar for å se...', 'pl': 'gotowy do zobaczenia...' }, { 'no': 'underveis', 'pl': 'po drodze' }, { 'no': 'uten', 'pl': 'bez (czegoś)' }, { 'no': 'en sommerfugl', 'pl': 'motyl' }, { 'no': 'å ankomme', 'pl': 'przybyć' }, { 'no': 'redd', 'pl': 'bojący się, wystraszony' }, { 'no': 'ta av deg', 'pl': 'rozbierz się' }, { 'no': 'skummel', 'pl': 'przerażający' }, { 'no': 'forskrekket', 'pl': 'scared, frightened' }, { 'no': 'rar', 'pl': 'dziwne' }, { 'no': 'å oppleve', 'pl': 'przeżyć, doświadczyć' }, { 'no': 'å være vant til', 'pl': 'być przyzwyczajonym do' }, { 'no': 'en/ei hud', 'pl': 'skóra' }, { 'no': 'en overraskelse', 'pl': 'niespodzianka' }, { 'no': 'et reveskinn', 'pl': 'futro lisa' }, { 'no': 'en rev', 'pl': 'lis' }, { 'no': 'pakke ut', 'pl': 'rozpakować' }, { 'no': 'trygg', 'pl': 'secure, safe' }, { 'no': 'kjent, velkjent', 'pl': 'dobrze znany' }, { 'no': 'sliten', 'pl': 'zmęczony' }, { 'no': 'en aktivitet', 'pl': 'aktywność' }, { 'no': 'å kaste', 'pl': 'rzucać' }, { 'no': 'nærmere', 'pl': 'bliźej, dokładniej' }, { 'no': 'sakte', 'pl': 'powoli' }, { 'no': 'endelig', 'pl': 'ostatecznie, w końcu' }, { 'no': 'å treffe', 'pl': 'spotkać, trafić' }, { 'no': 'å beregne', 'pl': 'obliczać, kalkulować' }, { 'no': 'verdens kuleste', 'pl': 'najfajniejszy na świecie' }, { 'no': 'å grue seg', 'pl': 'obawiać się, bać się, martwić się' }, { 'no': 'ordentlig', 'pl': 'uporządkowany' }, { 'no': 'en/ei gave', 'pl': 'prezent' }, { 'no': 'et håndarbeid', 'pl': 'praca ręczna, robótka ręczna' }, { 'no': 'ekkel', 'pl': 'odrażający, wstrętny, ohydny' }, { 'no': 'kamgarn', 'pl': 'włóczka' }, { 'no': 'en bunt', 'pl': 'packet, bundle, bunch' }, { 'no': 'en/ei såpe', 'pl': 'mydło' }, { 'no': 'noen gang', 'pl': 'kiedykolwiek' }, { 'no': 'noen ganger', 'pl': 'czasami' }, { 'no': 'lykkedagen', 'pl': 'szczęśliwy dzień' }, { 'no': 'en/ei lykke', 'pl': 'szczęście' }, { 'no': 'en/ei kjøring', 'pl': 'jazda' }, { 'no': 'å tulle', 'pl': 'żartować' }, { 'no': 'spent', 'pl': 'spięty' }, { 'no': 'en mose', 'pl': 'mech' }, { 'no': 'en klov', 'pl': 'racica' }, { 'no': 'en krem', 'pl': 'bita śmietana' }],


    [{ 'no': 'å drive med / å holde på med', 'pl': 'zajmować się' }, { 'no': 'et besøk', 'pl': 'odwiedziny, wizyta' }, { 'no': 'et hotell', 'pl': 'hotel' }, { 'no': 'å søke', 'pl': 'poszukiwać' }, { 'no': 'søke på en jobb', 'pl': 'apply for a job' }, { 'no': 'søke om studielån', 'pl': 'apply for a loan for one\'s studies' }, { 'no': 'en erfaring', 'pl': 'doświadczenie' }, { 'no': 'å ha erfaring med', 'pl': 'mieć doświadczenie z' }, { 'no': 'et regnskap', 'pl': 'rachunkowość' }, { 'no': 'et firma', 'pl': 'firma' }, { 'no': 'en utfordring', 'pl': 'wyzwanie' }, { 'no': 'å ta førerkort', 'pl': 'robić prawo jazdy' }, { 'no': 'kjøretimer', 'pl': 'kursy jazdy' }, { 'no': 'enig', 'pl': 'racja' }, { 'no': 'for en stund siden', 'pl': 'jakiś czas temu' }, { 'no': 'å sjekke', 'pl': 'sprawdzać, flirtować, czatować' }, { 'no': 'et nett', 'pl': 'sieć' }, { 'no': 'et tipse', 'pl': 'tip, wskazówka' }, { 'no': 'å savne', 'pl': 'tęsknić' }, { 'no': 'å glede seg over', 'pl': 'cieszyć się' }, { 'no': 'å glede seg til', 'pl': 'look forward to' }, { 'no': 'skål', 'pl': 'na zdrowie' }, { 'no': 'å oppfylle oppfyller oppfylte oppfylt', 'pl': 'spełniać' }, { 'no': 'søsken', 'pl': 'rodzeństwo' }, { 'no': 'en tvilling', 'pl': 'bliźniak' }, { 'no': 'en samtale', 'pl': 'rozmowa, conversation' }, { 'no': 'skilt skilte', 'pl': 'separated, divorced' }, { 'no': 'en teoridel', 'pl': 'część teoretyczna' }, { 'no': 'en prøve', 'pl': 'test, egzamin, próba' }, { 'no': 'en teoriprøve', 'pl': 'egzamin teoretyczny' }, { 'no': 'en teori', 'pl': 'teoria' }, { 'no': 'finnes', 'pl': 'znajdować się (am, are, is)' }, { 'no': 'å hilse', 'pl': 'pozdrawiać' }, { 'no': 'borte fra jobben', 'pl': 'z dala od pracy' }, { 'no': 'vondt i ryggen', 'pl': 'ból pleców' }, { 'no': 'en rygg', 'pl': 'plecy' }, { 'no': 'å klare', 'pl': 'zdołać, udać się (manage)' }, { 'no': 'en kollega', 'pl': 'kolega, współpracownik' }, { 'no': 'kollega av monica', 'pl': 'kolega moniki' }, { 'no': 'stakkars deg', 'pl': 'biedny ty' }, { 'no': 'å føle seg', 'pl': 'czuć się' }, { 'no': 'å si fra til', 'pl': 'przekazać' }, { 'no': 'senere', 'pl': 'później' }, { 'no': 'like dårlig', 'pl': 'tak samo źle' }, { 'no': 'like', 'pl': 'taki sam' }, { 'no': 'å kaste opp', 'pl': 'wymiotować' }, { 'no': 'å kaste', 'pl': 'rzucać' }, { 'no': 'å ta imot', 'pl': 'otrzymać' }, { 'no': 'et emne', 'pl': 'temat' }, { 'no': 'en sykdom, sykdommen', 'pl': 'choroba' }, { 'no': 'gi beskjed', 'pl': 'dać znać' }, { 'no': 'en feber', 'pl': 'gorączka' }, { 'no': 'slik, slikt, slike', 'pl': 'taki' }, { 'no': 'det var synd', 'pl': 'szkoda' }, { 'no': 'pass på deg selv', 'pl': 'dbaj o siebie' }, { 'no': 'å skaffe seg', 'pl': 'otrzymać' }, { 'no': 'heldigvis', 'pl': 'szczęśliwie' }, { 'no': 'en måte', 'pl': 'sposób' }, { 'no': 'en vikar', 'pl': 'zastępca' }, { 'no': 'en kvalifikasjon', 'pl': 'kwalifikacja' }, { 'no': 'deretter', 'pl': 'następnie' }, { 'no': 'en stilling', 'pl': 'posada, job, position' }, { 'no': 'slik, slikt, slike', 'pl': 'taki (such)' }, { 'no': 'offentlig', 'pl': 'publiczny' }, { 'no': 'en tjeneste', 'pl': 'usługa, praca' }, { 'no': 'en søknad', 'pl': 'podanie, aplikacja, wniosek' }, { 'no': 'en opplysning', 'pl': 'informacja' }, { 'no': 'en annonse for ledige stillinger', 'pl': 'ogłoszenie o wolnych stanowiskach' }, { 'no': 'en instruks', 'pl': 'instrukcja' }, { 'no': 'en brann', 'pl': 'pożar' }, { 'no': 'en branninstruks', 'pl': 'instrukcja pożarowa' }, { 'no': 'en bygning', 'pl': 'budynek' }, { 'no': 'på forhånd', 'pl': 'zawczasu (in advance)' }, { 'no': 'et brannvesen', 'pl': 'straż pożarna' }, { 'no': 'et telefonnummer', 'pl': 'numer telefonu' }, { 'no': 'å trykke på', 'pl': 'nacisnąć na' }, { 'no': 'å lukke, å stenge', 'pl': 'zamknąć' }, { 'no': 'en dør', 'pl': 'drzwi' }, { 'no': 'et vindu', 'pl': 'okno' }, { 'no': 'å forlate', 'pl': 'opuścić' }, { 'no': 'et samlingspunkt', 'pl': 'punk zbiórki' }, { 'no': 'straks', 'pl': 'natychmiast' }, { 'no': 'et utstyr', 'pl': 'sprzęt' }, { 'no': 'å slukke', 'pl': 'gasić' }, { 'no': 'en brannalarm', 'pl': 'alarm pożarowy' }, { 'no': 'en/ei mor, mødre, mødrene', 'pl': 'matka' }, { 'no': 'en/ei arbeidstid', 'pl': 'czas pracy' }, { 'no': 'en matpause', 'pl': 'przerwa na jedzenie' }, { 'no': 'å regne', 'pl': 'padać, liczyć' }, { 'no': 'å regne med', 'pl': 'wliczać, zawierać, liczyć się z' }, { 'no': 'en/ei overtid', 'pl': 'nadgodzina' }, { 'no': 'vanligvis', 'pl': 'zazwyczaj' }, { 'no': 'å utbetale', 'pl': 'wypłacać' }, { 'no': 'en/ei lønn', 'pl': 'pensja, zarobek' }, { 'no': 'å sette inn', 'pl': 'wpłacać' }, { 'no': 'en konto', 'pl': 'konto' }, { 'no': 'å trekke', 'pl': 'ciągnąć, wyciągnąć' }, { 'no': 'å trekke fra', 'pl': 'odliczyć, odjąć' }, { 'no': 'en skatt', 'pl': 'podatek' }, { 'no': 'en/ei sykemelding/sykmelding', 'pl': 'zwolnienie lekarskie' }, { 'no': 'straks', 'pl': 'natychmiast' }, { 'no': 'å melde', 'pl': 'zgłosić, ogłosić, powiadomić' }, { 'no': 'ellers', 'pl': 'w przeciwnym wypadku' }, { 'no': 'en/ei egenmelding', 'pl': 'self-certification of absence' }, { 'no': 'å dele inn, å inndele, å gruppere', 'pl': 'podzielić' }, { 'no': 'å øke', 'pl': 'zwiększyć (np. obroty, wiedzę, produkcję, pensję, prędkość)' }, { 'no': 'en sparke', 'pl': 'kopnięcie' }, { 'no': 'en klesbutikk', 'pl': 'sklep z ubraniami' }, { 'no': 'et storsenter', 'pl': 'galeria handlowa' }, { 'no': 'serviceinnstilt', 'pl': 'nastawiony na obsługę' }, { 'no': 'en søker', 'pl': 'aplikujący' }, { 'no': 'en sans', 'pl': 'świadomość' }, { 'no': 'lignende, liknende', 'pl': 'podobny' }, { 'no': 'en fordel', 'pl': 'zaleta, korzyść' }, { 'no': 'siste skrik', 'pl': 'ostatni dzwonek' }, { 'no': 'et skrik, skriket, skrik, skrikene', 'pl': 'krzyk' }, { 'no': 'en medarbeider', 'pl': 'co-worker, współpracownik' }, { 'no': 'jeg jobber halv stilling', 'pl': 'pracuję na pół etatu' }, { 'no': 'å burde, bør, burde, har burdet', 'pl': 'powinien, ought to, should' }, { 'no': 'energisk', 'pl': 'energiczny' }, { 'no': 'en mote', 'pl': 'moda' }, { 'no': 'dersom', 'pl': 'in case, w przypadku' }, { 'no': 'en frist', 'pl': 'termin, deadline' }, { 'no': 'søknadsfrist', 'pl': 'termin składania podania' }, { 'no': 'en hjelpepleier', 'pl': 'opiekun medyczny' }, { 'no': 'et omsorgssenter', 'pl': 'centrum opieki' }, { 'no': 'en omsorg', 'pl': 'troska, opieka' }, { 'no': 'i vikariat', 'pl': 'na zastępstwo' }, { 'no': 'i 100% stilling', 'pl': 'na 100% etatu' }, { 'no': 'en/ei avdeling', 'pl': 'wydział, oddział' }, { 'no': 'en avdelingssykepleier', 'pl': 'oddziałowa pielęgniarka/pielęgniarz' }, { 'no': 'å lagre', 'pl': 'przechować, składować' }, { 'no': 'del på facebook', 'pl': 'udostępnij (podziel się) na facebooku' }, { 'no': 'å skrive ut', 'pl': 'odpisać' }, { 'no': 'en tiltredelse', 'pl': 'przystąpienie' }, { 'no': 'en kokk', 'pl': 'kucharz, szef kuchni' }, { 'no': 'en dagligvare', 'pl': 'produkty spożywcze' }, { 'no': 'daglig', 'pl': 'codziennie' }, { 'no': 'fleksibel', 'pl': 'elastyczny' }, { 'no': 'kassefunksjon', 'pl': 'obsługa kasy' }, { 'no': 'en leder', 'pl': 'kierownik' }, { 'no': 'ulik, ulikt, ulike', 'pl': 'różny, inny' }, { 'no': 'å bestemme', 'pl': 'decydować, postanowić' }, { 'no': 'et rollespill', 'pl': 'odgrywanie ról' }, { 'no': 'et spill', 'pl': 'gra' }, { 'no': 'å bli innkalt til', 'pl': 'zostać wezwanym na' }, { 'no': 'en/ei leddsetning', 'pl': 'zdanie podrzędne' }, { 'no': 'sammensatt, sammensatte', 'pl': 'złożony' }, { 'no': 'et trekk', 'pl': 'odliczenie, dedukcja, minus' }, { 'no': 'et lag, laget, lag, lagene', 'pl': 'drużyna, zespół, grupa' }, { 'no': 'en deltaker', 'pl': 'uczestnik' }, { 'no': 'en/ei trapp, trapper, trappene', 'pl': 'schody' }, { 'no': 'en/ei rulletrapp', 'pl': 'schody ruchome' }, { 'no': 'slå på', 'pl': 'włączyć' }, { 'no': 'slå av', 'pl': 'wyłączyć' }, { 'no': 'brannansvarlig', 'pl': 'odpowiedzialny za ogień' }, { 'no': 'et klarsignal', 'pl': 'zielone światło' }, { 'no': 'en samling', 'pl': 'zgromadzenie, kolekcja, montaż' }],
    ...
    [{ 'no': 'å skje, skjer, skjedde, har skjedd', 'pl': 'zdarzyć się' }, { 'no': 'tidligere, før', 'pl': 'wcześniej' }, { 'no': 'en lek', 'pl': 'zabawa' }, { 'no': 'skikkelig', 'pl': 'bardzo' }, { 'no': 'skikkelig gøy', 'pl': 'bardzo zabawny' }, { 'no': 'nødt', 'pl': 'zmuszony' }, { 'no': 'sannhet', 'pl': 'prawda' }, { 'no': 'altså', 'pl': 'tak więc' }, { 'no': 'å snurre', 'pl': 'kręcić się, obracać się' }, { 'no': 'å være nødt til', 'pl': 'być zmuszonym do' }, { 'no': 'prompa du?', 'pl': 'pierdnęłaś ty?' }, { 'no': 'et prompe', 'pl': 'pierdnięcie' }, { 'no': 'tillatt', 'pl': 'dozwolony, dopuszczony' }, { 'no': 'forelsket, forelska', 'pl': 'zakochany' }, { 'no': 'en skåring', 'pl': 'wynik, punkt (score)' }, { 'no': 'rar', 'pl': 'dziwny (strange)' }, { 'no': 'å bli tatt', 'pl': 'zostać złapanym' }, { 'no': 'en tegn', 'pl': 'znak (sign)' }, { 'no': 'en truse', 'pl': 'majtki' }, { 'no': 'et virke', 'pl': 'drewno' }, { 'no': 'å virke', 'pl': 'pracować, wydawać się, wyglądać (seem, appear)' }, { 'no': 'en kompliment', 'pl': 'komplement' }, { 'no': 'slapp av selv', 'pl': 'sam się uspokój' }, { 'no': 'en mens', 'pl': 'okres, menstruacja' }, { 'no': 'en deig', 'pl': 'surowe ciasto (dough)' }, { 'no': 'ordentlig', 'pl': 'właściwie' }, { 'no': 'et tak', 'pl': 'chwyt (grip)' }, { 'no': 'redd', 'pl': 'wystraszony' }, { 'no': 'å kna', 'pl': 'ugniatać (knead)' }, { 'no': 'å skvise', 'pl': 'ściskać (squeeze)' }, { 'no': 'en gjær', 'pl': 'drożdże (yeast)' }, { 'no': 'ømfintlig', 'pl': 'wrażliwy, delikatny' }, { 'no': 'en prosess', 'pl': 'proces (process)' }, { 'no': 'rå', 'pl': 'surowy (rough)' }, { 'no': 'gjør du narr av meg?', 'pl': 'wyśmiewasz się ze mnie?' }, { 'no': 'foreslå', 'pl': 'zaproponować' }, { 'no': 'en person', 'pl': 'osoba' }, { 'no': 'å kåre, kårer, kåret, kåret', 'pl': 'choose' }, { 'no': 'å kysse, kysset', 'pl': 'pocałować' }, { 'no': 'å le, ler, lo, ledd', 'pl': 'smiać się' }, { 'no': 'ydmykende', 'pl': 'upokażający' }, { 'no': 'å lage lager laget (el lagde laga) laget (el lagd laga)]', 'pl': 'przygotować' }, { 'no': 'en flause', 'pl': 'pomyłka' }, { 'no': 'en/ei liste', 'pl': 'lista' }, { 'no': 'å stikke, stikker, stakk, stukket', 'pl': 'śpieszyć się, biegnąć' }, { 'no': 'å feire', 'pl': 'świętować (celebrate)' }, { 'no': 'årlig', 'pl': 'roczny' }, { 'no': 'en ryggsekk', 'pl': 'plecak' }, { 'no': 'heldig', 'pl': 'szczęśliwy' }, { 'no': 'fjerne', 'pl': 'skasować' }, { 'no': 'gjemme, gjemmer, gjemte, gjemt', 'pl': 'chować, ukrywać' }, { 'no': 'en gym, gymmen', 'pl': 'wuef' }, { 'no': 'heller', 'pl': 'też nie (either, neither)' }, { 'no': 'å digge', 'pl': 'uwielbiać' }, { 'no': 'en kontroll', 'pl': 'kontrola, kontrolowanie' }, { 'no': 'å veilede', 'pl': 'radzić (give advice)' }, { 'no': 'å henge opp', 'pl': 'rozwiesić' }, { 'no': 'en utstilling', 'pl': 'wystawa' }, { 'no': 'en fotoutstilling', 'pl': 'pokaz zdjęć' }, { 'no': 'et dikt', 'pl': 'wiersz' }, { 'no': 'hva mener du? ooooo...', 'pl': 'what do you mean? ooooo...' }, { 'no': 'for sent / for seint', 'pl': 'spóźniony' }, { 'no': 'pga.', 'pl': 'på grunn av' }, { 'no': 'dum', 'pl': 'głupie' }, { 'no': 'å lyve, lyver, løy, løyet', 'pl': 'klamać' }, { 'no': 'ærlig', 'pl': 'szczery' }, { 'no': 'utkledd som en katt', 'pl': 'przebrany za kota' }, { 'no': 'å samle på frimerker', 'pl': 'zbierać znaczki' }, { 'no': 'å ordne opp', 'pl': 'uporządkować' }, { 'no': 'å handle', 'pl': 'działać' }, { 'no': 'hva handler det om?', 'pl': 'o czym to jest?' }, { 'no': 'en følelse, følelser, følelsene', 'pl': 'uczucie' }, { 'no': 'det er noe jeg må fortelle deg', 'pl': 'jest coś co muszę ci opowiedzieć' }, { 'no': 'å be, ber, ba (el bad), har bedt', 'pl': 'zaprosić' }, { 'no': 'et stoff', 'pl': 'tkanina' }, { 'no': 'synd jeg gikk glipp av det', 'pl': 'szkoda że mnie to ominęło' }, { 'no': 'å virke', 'pl': 'wydawać się' }, { 'no': 'en kattekampanje', 'pl': 'kampania dla kotów' }, { 'no': 'å gi opp', 'pl': 'poddać się (gave up)' }, { 'no': 'en sang', 'pl': 'piosenka' }, { 'no': 'en kattunge', 'pl': 'kotek' }, { 'no': 'å funke', 'pl': 'funkcjonować, działać' }, { 'no': 'å overtale til (å overtale ham til)', 'pl': 'namawiać (persuade)' }, { 'no': 'teite', 'pl': 'głupi (silly)' }, { 'no': 'å gjøre teite greier', 'pl': 'robić głupie rzeczy' }, { 'no': 'en greie', 'pl': 'gadżet' }, { 'no': 'å skylde penger', 'pl': 'być winnym pieniądze' }, { 'no': 'katteører', 'pl': 'uszy kota' }, { 'no': 'finne ut', 'pl': 'dowiedzieć się (find ut)' }, { 'no': 'flau, flaut, flaue', 'pl': 'bez smaku, zawstydzony' }, { 'no': 'en do', 'pl': 'toaleta, wc' }, { 'no': 'allerede', 'pl': 'już (already)' }, { 'no': 'hva er skjedd med deg?', 'pl': 'co jest z tobą?' }, { 'no': 'vil du se ut som hedwig?', 'pl': 'chcesz wyglądać jak hedwida?' }, { 'no': 'den positive siden', 'pl': 'pozytywna strona' }, { 'no': 'å nekte', 'pl': 'zaprzeczać, odmawiać' }, { 'no': 'en blikkontakt', 'pl': 'kontakt wzrokowy' }, { 'no': 'en pupill', 'pl': 'źrenica' }, { 'no': 'å utvide seg', 'pl': 'rozszerzać się' }, { 'no': 'å tøffe seg', 'pl': 'zgrywać twardziela' }, { 'no': 'å dytte', 'pl': 'pchać' }, { 'no': 'å knuse et hjerte', 'pl': 'złamać serce' }, { 'no': 'å knuse', 'pl': 'rozbić (crush)' }, { 'no': 'et merke', 'pl': 'znak, cecha (mark)' }, { 'no': 'et tull', 'pl': 'żart (joke)' }, { 'no': 'ikke tull', 'pl': 'nie żartuj' }, { 'no': 'en vits', 'pl': 'żart' }, { 'no': 'å krype', 'pl': 'czołgać się (crawl)' }, { 'no': 'nede', 'pl': 'na dole (down)' }, { 'no': 'lav, lavt, lave', 'pl': 'niski (low)' }, { 'no': 'forresten', 'pl': 'by the way' }, { 'no': 'farlig', 'pl': 'niebezpieczny, ryzykowny' }, { 'no': 'bryst', 'pl': 'pierś' }, { 'no': 'en kreft', 'pl': 'rak' }, { 'no': 'en pupp, pupper', 'pl': 'cycek, cycki' }, { 'no': 'ikke skyld på meg', 'pl': 'nie obwiniaj mnie' }, { 'no': 'misunnelig', 'pl': 'zazdrosny' }, { 'no': 'å innrømme', 'pl': 'przyznać się' }, { 'no': 'innrøm det', 'pl': 'przyznaj to' }, { 'no': 'evighet', 'pl': 'wieczność (eternity)' }, { 'no': 'å skremme', 'pl': 'przestraszyć (scare)' }, { 'no': 'surpomp', 'pl': 'sur person' }, { 'no': 'lur, lure, lurt', 'pl': 'sprytnie (clever)' }, { 'no': 'gæren', 'pl': 'zwariowany (crazy)' }, { 'no': 'å fortjene', 'pl': 'zasługiwać' }, { 'no': 'hun fortjente det', 'pl': 'zasłużyła na to' }, { 'no': 'å hate', 'pl': 'nienawidzić' }, { 'no': 'å ødelegge', 'pl': 'niszczyć' }],


    [{ 'no': 'en egenskap', 'pl': 'cecha, jakość' }, { 'no': 'rolig', 'pl': 'spokojny' }, { 'no': 'å telle penger', 'pl': 'liczyć pieniądze' }, { 'no': 'å ro', 'pl': 'wiosłować' }, { 'no': 'å ligne, å likne', 'pl': 'przypominać' }, { 'no': 'fargelagte', 'pl': 'pokolorowany' }, { 'no': 'avslappet', 'pl': 'zrelaksowany' }, { 'no': 'et leketøy', 'pl': 'zabawka' }, { 'no': 'hjelpsom', 'pl': 'pomocny' }, { 'no': 'en nabo', 'pl': 'sąsiad' }, { 'no': 'å holde øye med', 'pl': 'mieć oko na' }, { 'no': 'mens', 'pl': 'podczas' }, { 'no': 'kontantstøtte', 'pl': 'zasiłek opiekuńczy' }, { 'no': 'en innvandrer', 'pl': 'imigrant' }, { 'no': 'å kose seg', 'pl': 'spędzać czas w miły sposób' }, { 'no': 'en barnehageplass', 'pl': 'miejsce w przedszkolu' }, { 'no': 'å fylle ett år', 'pl': 'skończyć rok (o wieku)' }, { 'no': 'en kommune', 'pl': 'gmina' }, { 'no': 'strenge', 'pl': 'ścisły, rygorystyczny' }, { 'no': 'en straff', 'pl': 'kara' }, { 'no': 'fysisk', 'pl': 'fizyczny' }, { 'no': 'en støtte', 'pl': 'wsparcie' }, { 'no': 'statlig', 'pl': 'rządowy' }, { 'no': 'en skolefritidsordning (sfo)', 'pl': 'przedszkole z aktywnościami' }, { 'no': 'en plikt', 'pl': 'obowiązek' }, { 'no': 'å tilby, tilbyr, tilbød (el tilbøy tilbydde), tilbudt (el tilbydd)', 'pl': 'zaoferować' }, { 'no': 'et foreldremøte', 'pl': 'spotkanie rodziców (wywiadówka)' }, { 'no': 'en konferanse', 'pl': 'konferencja' }, { 'no': 'til én og én', 'pl': 'sam na sam ???' }, { 'no': 'tidlig, tidligere, tidligst', 'pl': 'wcześnie, wcześniej, najpierw' }, { 'no': 'en grunnskole', 'pl': 'szkoła podstawowa (dziesięcioletnia)' }, { 'no': 'videregående opplæring', 'pl': 'szkoła średnia (liceum, high school)' }, { 'no': 'et innhold', 'pl': 'zawartość' }, { 'no': 'å kalle, kaller, kalte, kalt', 'pl': 'nazwać, nazywać' }, { 'no': 'et fag, faget, fag, fagene', 'pl': 'przedmiot (w szkole), branża, zawód, fach' }, { 'no': 'en foresatt, foresatte', 'pl': 'opiekun' }, { 'no': 'å orientere, orienterer, orienterte, orientert', 'pl': 'zorientować się' }, { 'no': 'å velge, velger, valgte, valgt', 'pl': 'wybierać' }, { 'no': 'en hovedinngang', 'pl': 'główne wejście' }, { 'no': 'et oppmøte kl. 8:15', 'pl': 'zbiórka o 8:15' }, { 'no': 'å tørre, tør, torde (el turte), tort (el turt)', 'pl': 'odważyć się' }, { 'no': 'å overta', 'pl': 'przejąć' }, { 'no': 'sannsynlig', 'pl': 'prawdopodobny' }, { 'no': 'et regnestykke', 'pl': 'obliczenie' }, { 'no': 'sitteunderlag', 'pl': 'podkładka do siedzenia na ziemi' }, { 'no': 'hva har de på seg?', 'pl': 'co oni mają na sobie? (o ubraniach)' }, { 'no': 'en preposisjon', 'pl': 'przyimek' }, { 'no': 'å sikre', 'pl': 'chronić, zapewniać, gwarantować' }, { 'no': 'å bli kjent med ... på', 'pl': 'poznać/zapoznać się z ...' }, { 'no': 'å ha det travelt', 'pl': 'być zabieganym' }, { 'no': 'et klima', 'pl': 'klimat' }, { 'no': 'å klage, klager, klaget, har klaget', 'pl': 'narzekać' }, { 'no': 'et samfunnsfag', 'pl': 'nauki o społeczeństwie' }, { 'no': 'en kunst', 'pl': 'sztuka' }, { 'no': 'et håndverk, -verket, -verk, -verkene', 'pl': 'robótki ręczne' }, { 'no': 'et livssyn', 'pl': 'światopogląd' }, { 'no': 'usikker', 'pl': 'niepewny' }, { 'no': 'en/ei åpningstid', 'pl': 'czas otwarcia' }, { 'no': 'en mulighet', 'pl': 'możliwość' }, { 'no': 'legg fram informasjonen', 'pl': 'przedstawić/przekazać wiadomość' }, { 'no': 'å legge fram', 'pl': 'przedstawić/przekazać' }, { 'no': 'en ungdomsskole', 'pl': 'gimnazjum' }, { 'no': 'matpause storefri', 'pl': 'długa przerwa na jedzenie' }, { 'no': 'en oversikten', 'pl': 'ankieta, podsumowanie, zarys' }, { 'no': 'å savne', 'pl': 'tęsknić' }, { 'no': 'et samarbeid', 'pl': 'współpraca' }, { 'no': 'å innkalle', 'pl': 'wezwać' }, { 'no': 'å sikke på om', 'pl': 'być pewnym (czegoś)' }, { 'no': 'å ta kontakt', 'pl': 'utrzymywać kontakt' }, { 'no': 'utenom', 'pl': 'oprócz, poza' }, { 'no': 'ordinær', 'pl': 'zwykły' }, { 'no': 'å holde til', 'pl': 'trzymać się' }, { 'no': 'en lek', 'pl': 'zabawa' }, { 'no': 'et opplegg', 'pl': 'plan, harmonogram, program' }, { 'no': 'en anledning', 'pl': 'możliwość, okazja' }, { 'no': 'utetøy', 'pl': 'odzież wierzchnia' }, { 'no': 'et tøy', 'pl': 'materiał, tkanina' }, { 'no': 'en/ei måltid', 'pl': 'czas na posiłek' }, { 'no': 'en bruker, brukeren, brukere, brukerne', 'pl': 'użytkownik' }, { 'no': 'å forlate', 'pl': 'opuścić, zostawić' }, { 'no': 'ikke bare', 'pl': 'nie tylko' }, { 'no': 'vanligvis', 'pl': 'zazwyczaj' }, { 'no': 'en karakter', 'pl': 'ocena, stopień' }, { 'no': 'å kaste bort livet', 'pl': 'szkoda życia' }, { 'no': 'å kaste bort', 'pl': 'marnować' }, { 'no': 'en del', 'pl': 'część' }, { 'no': 'en elev, eleven, elever, elevene', 'pl': 'uczeń' }, { 'no': 'et bilde', 'pl': 'obrazek' }, { 'no': 'lik, likt, like', 'pl': 'równy, taki sam' }, { 'no': 'ulik, ulikt, ulike', 'pl': 'różny' }, { 'no': 'gammel, gammelt, gamle', 'pl': 'stary' }, { 'no': 'å bestemme', 'pl': 'decydować, postanowić' }, { 'no': 'et argument argumenter (el argument) argumentene', 'pl': 'argument' }, { 'no': 'et argument for', 'pl': 'argument za' }, { 'no': 'et argument mot', 'pl': 'argument przeciw' }, { 'no': 'mot', 'pl': 'przeciw' }, { 'no': 'en timeplan', 'pl': 'plan lekcji' }, { 'no': 'et trinn, trinnet, trinn, trinnene', 'pl': 'stopień' }, { 'no': 'ikt', 'pl': 'informasjons og kommunikasjonsteknologi' }, { 'no': 'en teknologi -logier -logiene', 'pl': 'technologia' }, { 'no': 'et naturfag', 'pl': 'nauki przyrodnicze' }, { 'no': 'et skoleår', 'pl': 'rok szkolny' }, { 'no': 'en drikke', 'pl': 'coś do picia, picie' }, { 'no': 'frivillig', 'pl': 'dobrowolny' }, { 'no': 'minst to ganger', 'pl': 'co najmniej dwa razy' }, { 'no': 'en utviklingssamtale', 'pl': 'rozmowa motywująca' }, { 'no': 'lekser', 'pl': 'lekcje (jako praca domowa)' }, { 'no': 'leksjoner', 'pl': 'lekcje (w klasie)' }, { 'no': 'å orke', 'pl': 'być zdolnym do zrobienia czegoś, mieć egergię do zrobienia czegoś' }, { 'no': 'en advokat', 'pl': 'adwokat' }, { 'no': 'en journalist /szonalist/', 'pl': 'dziennikarz' }, { 'no': 'en rørlegger', 'pl': 'hydraulik' }, { 'no': 'et trykk', 'pl': 'ciśnienie' }, { 'no': 'en stavelse', 'pl': 'sylaba' }, { 'no': 'en lyd', 'pl': 'dźwięk' }, { 'no': 'å mangle', 'pl': 'brakować' }, { 'no': 'en norskprøve', 'pl': 'egzamin z norweskiego' }, { 'no': 'jeg håper at han vil trives', 'pl': '???' }, { 'no': 'en studieretning', 'pl': 'kierunek studiów' }, { 'no': 'en retning', 'pl': 'kierunek' }, { 'no': 'teoretisk, teoretiske', 'pl': 'teoretyczny' }, { 'no': 'praktisk, praktiske', 'pl': 'praktyczny' }, { 'no': 'en/ei vekt', 'pl': 'waga (masa lub urządzenie), znaczenie' }, { 'no': 'å tjene', 'pl': 'zarabiać, zasługiwać, serwować' }, { 'no': 'jeg er lei av teori', 'pl': 'mam dosyć teorii' }, { 'no': 'å gå fristen ut', 'pl': 'termin upływa' }, { 'no': 'en frist', 'pl': 'deadline' }, { 'no': 'ordentlig', 'pl': 'uporządkowany, porządny' }, { 'no': 'en toppkarakter', 'pl': 'najwyższa ocena' }, { 'no': 'et skolelys', 'pl': 'prymus' }, { 'no': 'en/ei framtid', 'pl': 'przyszłość' }, { 'no': 'kjedelig', 'pl': 'nudny' }, { 'no': 'finnes', 'pl': 'istnieć' }, { 'no': 'i stedet for oss', 'pl': 'zamiast nas' }, { 'no': 'å mene', 'pl': 'znaczyć, mieć na myśli' }, { 'no': 'å lure på', 'pl': 'być ciekawym' }, { 'no': 'et sammendrag, -draget, -drag, -dragene, (el -draga)', 'pl': 'podsumowanie' }, { 'no': 'å bestemme', 'pl': 'postanowić' }, { 'no': 'enig, enige', 'pl': 'zgodny' }, { 'no': 'ifølge', 'pl': 'według' }, { 'no': 'å fylle ut', 'pl': 'skończyć' }, { 'no': 'en karakter', 'pl': 'ocena' }, { 'no': 'å vare', 'pl': 'trwać' }, { 'no': 'obligatorisk, obligatoriske', 'pl': 'obowiązkowy' }, { 'no': 'å fortsette fortsetter fortsatte har fortsatt', 'pl': 'kontynuować' }, { 'no': 'å utdanne seg', 'pl': 'kształcić się' }, { 'no': 'gratis', 'pl': 'darmowy' }, { 'no': 'et yrkesfaglig program', 'pl': 'program zawodowy' }, { 'no': 'en undervisning', 'pl': 'nauczanie' }, { 'no': 'en arbeidspraksis', 'pl': 'praktyki zawodowe' }, { 'no': 'en bedrift', 'pl': 'przedsiębiorstwo' }, { 'no': 'kvalifisert, kvalifiserte', 'pl': 'wykwalifikowany' }, { 'no': 'å bli kvalifisert til', 'pl': 'być wykwalifikowanym do (czegoś)' }, { 'no': 'en snekker', 'pl': 'stolarz' }, { 'no': 'en høyskole', 'pl': 'szkoła wyższa' }, { 'no': 'ã ta tre ãr', 'pl': 'zająć trzy lata' }, { 'no': 'mer vekt på', 'pl': 'większy nacisk na' }, { 'no': 'en kombinasjon', 'pl': 'kombinacja' }, { 'no': 'en barne og ungdomsarbeider', 'pl': 'osoba do pracy z dziećmi i młodzieżą' }, { 'no': 'et studieforberedende program', 'pl': 'program przygotowania do studiów' }, { 'no': 'et barnetrinn', 'pl': 'szkoła podstawowa' }, { 'no': 'et ungdomstrinn', 'pl': 'gimnazjum' }, { 'no': 'opptatt', 'pl': 'zajęty' }, { 'no': 'et universitet universitetet', 'pl': 'uniwersytet' }, { 'no': 'hellas', 'pl': 'grecja' }, { 'no': 'gresk', 'pl': 'grecki' }, { 'no': 'et prosjekt', 'pl': 'projekt' }, { 'no': 'ufornuftig', 'pl': 'nierozsądny' }, { 'no': 'fornuftig', 'pl': 'rozsądny' }, { 'no': 'ansvarlig', 'pl': 'odpowiedzialny' }, { 'no': 'uansvarlig', 'pl': 'nieodpowiedzialny' }, { 'no': 'ubehagelig', 'pl': 'nieprzyjemny, niemiły' }, { 'no': 'verdt', 'pl': 'warty' }, { 'no': 'overbelaste', 'pl': 'przeciążony' }, { 'no': 'en/ei matforgiftning', 'pl': 'zatrucie pokarmowe' }, { 'no': 'en/ei forgiftning', 'pl': 'zatrucie' }, { 'no': 'et munnbind', 'pl': 'maseczka ochronna' }, { 'no': 'å foretrekke -trekker -trakk -trukket', 'pl': 'preferować' }, { 'no': 'en fordel', 'pl': 'zaleta, korzyść' }, { 'no': 'en/ei ulempe', 'pl': 'wada' }, { 'no': 'en/ei løsning', 'pl': 'rozwiązanie' }, { 'no': 'å overnatte', 'pl': 'nocować' }, { 'no': 'ei løype', 'pl': 'szlak' }, { 'no': 'å anmelde', 'pl': 'recenzować' }, { 'no': 'en anmelder', 'pl': 'krytyka' }, { 'no': 'en anmeldelse', 'pl': 'recenzja' }, { 'no': 'å gå i vasken', 'pl': '(coś) poszło nie po naszej myśli' }, { 'no': 'å planlegge', 'pl': 'planować' }, { 'no': 'å påvirke', 'pl': 'wpływać' }, { 'no': 'å gå ned i vekt', 'pl': 'zrzucić wagę' }, { 'no': 'å oppdage', 'pl': 'odkrywać' }, { 'no': 'rørende', 'pl': 'poruszający' }, { 'no': 'å like seg godt / trives', 'pl': 'czuć się dobrze' }, { 'no': 'å oppdage', 'pl': 'odkrywać' }],



    [{ 'no': 'gründer', 'pl': 'złożyciel' }, { 'no': 'å satse', 'pl': 'zaryzykować, podjąć wysiłek, cofnąć się' }, { 'no': 'å funke', 'pl': 'działa' }, { 'no': 'våt', 'pl': 'mokry' }, { 'no': 'å måle', 'pl': 'mierzyć' }, { 'no': 'et mål', 'pl': 'cel' }, { 'no': 'et steg', 'pl': 'krok' }, { 'no': 'skapt jobb', 'pl': 'utworzone miejsce pracy' }, { 'no': 'å skape', 'pl': 'stworzyć' }, { 'no': 'egen', 'pl': 'własny' }, { 'no': 'en\\ ei løsning', 'pl': 'rozwiązanie' }, { 'no': 'å bytte', 'pl': 'zmieniać' }, { 'no': 'en bleie', 'pl': 'pielucha' }, { 'no': 'å kaste', 'pl': 'wyrzucić' }, { 'no': 'enklere løsninger', 'pl': 'proste rozwiązania' }, { 'no': 'enkel', 'pl': 'prosty' }, { 'no': 'saker', 'pl': 'przypadki' }, { 'no': 'en\\ ei sak', 'pl': 'przypadek' }, { 'no': 'en valgkamp', 'pl': 'kampania wyborcza' }, { 'no': 'et tema', 'pl': 'temat' }, { 'no': 'å foreslå', 'pl': 'proponować, sugerować' }, { 'no': 'klok', 'pl': 'mądry' }, { 'no': 'kloke hoder', 'pl': 'mądre głowy' }, { 'no': 'realisere drømmer', 'pl': 'realizować marzenia' }, { 'no': 'en satsing', 'pl': 'inwestycja' }, { 'no': 'lettere', 'pl': 'łatwiejsze' }, { 'no': 'en nedgang', 'pl': 'spadek, zejście' }, { 'no': 'gjennomsikting', 'pl': 'przezroczysty' }, { 'no': 'å beskyte', 'pl': 'chronić' }, { 'no': 'mange ord', 'pl': 'dużo słów' }, { 'no': 'en skilpadde', 'pl': 'żółw' }, { 'no': 'å dykke', 'pl': 'nurkować' }, { 'no': 'en nekkøl', 'pl': 'klucz' }, { 'no': 'enn', 'pl': 'niż' }, { 'no': 'av alle', 'pl': 'ze wszystkich' }, { 'no': 'ille', 'pl': 'zły' }, { 'no': 'en krykke', 'pl': 'kula' }, { 'no': 'innebygd', 'pl': 'doczepiany, dobudowany' }, { 'no': 'en blyant', 'pl': 'ołówek' }, { 'no': 'et viskelær', 'pl': 'gumka do ścierania' }, { 'no': 'å løse', 'pl': 'zwolnić' }, { 'no': 'det løser generalt hverdagsproblem', 'pl': 'torozwiązuje generalne problemy życia codziennego' }, { 'no': 'å utvikle', 'pl': 'rozwiązać się' }, { 'no': 'å satse på', 'pl': 'postaw na' }, { 'no': 'en trivsel', 'pl': 'komfort' }, { 'no': 'en bedrift', 'pl': 'przedsiębiorstwo' }, { 'no': 'lønnsom', 'pl': 'dajacy profit' }, { 'no': 'lønnsomme forretninger', 'pl': 'dajacy korzyści' }, { 'no': 'en innovasjon', 'pl': 'innowacja' }, { 'no': 'en vedtekt', 'pl': 'regulacja, zasada' }, { 'no': 'en god posisjon internasjonalt', 'pl': 'dobra pozycja międzynarodowa' }, { 'no': 'pga', 'pl': 'z powodu' }, { 'no': 'en\\ ei utvikling', 'pl': 'rozwój' }, { 'no': 'å skje på', 'pl': 'natrafic' }, { 'no': 'en fornyelse', 'pl': 'odnowienie' }, { 'no': 'en endring', 'pl': 'zmiana' }, { 'no': 'en næring', 'pl': 'pokarm' }, { 'no': 'framover', 'pl': 'do przodu' }, { 'no': 'virkelig', 'pl': 'naprawdę' }, { 'no': 'å nå', 'pl': 'dosięgnąć, sięgnąć' }, { 'no': 'basert på', 'pl': 'oparty na' }, { 'no': 'hva som helst', 'pl': 'wszystko' }, { 'no': 'hva som helst er mulig', 'pl': 'wszystko jest mozliwe' }, { 'no': 'blanding av', 'pl': 'mieszanka z' }, { 'no': 'en spørrelek', 'pl': 'quiz' }, { 'no': 'enorm', 'pl': 'ogromny' }, { 'no': 'et engasjement', 'pl': 'angaż' }, { 'no': 'å engasjement', 'pl': 'zaangażowanie' }, { 'no': 'å interesse', 'pl': 'zainteresowanie' }, { 'no': 'forretningsmessig', 'pl': 'komercyjny' }, { 'no': 'bli en sukcess forretningsmessig', 'pl': 'stać się sukcesem komercyjnym' }, { 'no': 'å vant', 'pl': 'mieć w zwyczaju' }, { 'no': 'å gråt', 'pl': 'plakać' }, { 'no': 'å funne opp', 'pl': 'wynalezć' }, { 'no': 'å forbedre', 'pl': 'polepszyć, ulepszyć, polepszyć' }, { 'no': 'jeg hadde lærevansker', 'pl': 'mialem trudności w nauce' }, { 'no': 'likevel', 'pl': 'mimo wszystko' }, { 'no': 'å engasjere', 'pl': 'angażować' }, { 'no': 'ivrig', 'pl': 'gorliwy' }, { 'no': 'et forslag', 'pl': 'propozycja' }, { 'no': 'å ha mot til å si ifra', 'pl': 'miec odwagę powiedzieć wlasne zdanie' }, { 'no': 'å si ifra', 'pl': 'powiedzieć' }, { 'no': 'en dypere relasjon', 'pl': 'głębsza relacja' }, { 'no': 'å oppfylle visjon', 'pl': 'zrealizować wizję' }, { 'no': 'en bekreftelse', 'pl': 'potwierdzenie, zaświadczenie zatwierdzenie' }, { 'no': 'et bål', 'pl': 'ognisko, stos' }, { 'no': 'utrolig', 'pl': 'niesamowity' }, { 'no': 'klar over', 'pl': 'zgodny' }, { 'no': 'å nærme seg', 'pl': 'zbliżać się' }, { 'no': 'egentlig', 'pl': 'naprawdę' }, { 'no': 'å eie', 'pl': 'posiadac' }, { 'no': 'et forløp', 'pl': 'przebieg zdarzeń, kierunek' }, { 'no': 'befriende', 'pl': 'wyzwalajacy' }, { 'no': 'å ble ofret', 'pl': 'złożyć ofiarę' }, { 'no': 'nok ofret', 'pl': 'wystarczająco dużo poświęcenia' }, { 'no': 'en kjernefamilie', 'pl': 'rodzina nuklearna' }, { 'no': 'en trygge ramme', 'pl': 'bezpieczna rama' }, { 'no': 'riktige', 'pl': 'poprawny' }, { 'no': 'å greie', 'pl': 'zarządzać' }, { 'no': 'å hemme seg', 'pl': 'hamowac' }, { 'no': 'det hemmer deg', 'pl': 'to hamuje cie' }, { 'no': 'å oppdage', 'pl': 'odkryć' }, { 'no': 'en sfære', 'pl': 'sfera' }, { 'no': 'en bable', 'pl': 'bąbel, bańka' }, { 'no': 'å sprekke', 'pl': 'pęknięcie' }, { 'no': 'et tall', 'pl': 'numer' }, { 'no': 'safistikerte', 'pl': 'wyfafinowany' }, { 'no': 'å levere', 'pl': 'dostarczyć' }, { 'no': 'en trygghet', 'pl': 'bezpieczeństwo' }, { 'no': 'å forsvinne', 'pl': 'zniknąć' }, { 'no': 'enda', 'pl': 'wciąż, jeszcze' }, { 'no': 'å oppforde', 'pl': 'zachęcić, zaprosić' }, { 'no': 'et steg', 'pl': 'krok' }, { 'no': 'å skaffe seg', 'pl': 'uzyskać' }, { 'no': 'et styr', 'pl': 'kontrola' }, { 'no': 'en nettverksruter', 'pl': 'ruter sieciowy' }, { 'no': 'raskt', 'pl': 'szybko' }, { 'no': 'sitlende', 'pl': 'w pozycji siedzacej' }, { 'no': 'en besluktning', 'pl': 'decyzja' }, { 'no': 'en\\ ei samlet', 'pl': 'zebrane' }, { 'no': 'slitt', 'pl': 'używany' }, { 'no': 'fast', 'pl': 'solidny' }, { 'no': 'å knekke', 'pl': 'złamac, łamać' }, { 'no': 'å puste', 'pl': 'oddychać' }, { 'no': 'sidelengs', 'pl': 'bokiem' }, { 'no': 'en splint', 'pl': 'drzazga' }, { 'no': 'en elg', 'pl': 'łoś' }, { 'no': 'et grep', 'pl': 'chwyt' }, { 'no': 'kjekk', 'pl': 'atrakcyjny' }, { 'no': 'annerledes', 'pl': 'inny' }, { 'no': 'en nyskaping', 'pl': 'innowacja' }, { 'no': 'unikt', 'pl': 'wyjatkowy' }, { 'no': 'et kjennskap', 'pl': 'wiedza' }, { 'no': 'eget', 'pl': 'posiadać' }, { 'no': 'å sjekke', 'pl': 'flirtowac, rozmawiać' }, { 'no': 'lov til', 'pl': 'dozwolony' }, { 'no': 'å skvise', 'pl': 'ścisnąć' }, { 'no': 'å utfordre', 'pl': 'wzywac na pojedynek' }, { 'no': 'en kjempe', 'pl': 'olbrzym' }, { 'no': 'rasjonell', 'pl': 'racjonalny' }, { 'no': 'for platt', 'pl': 'zbyt oklepany' }, { 'no': 'det må bli stilig nok', 'pl': 'to musi byc wystarczajaco stylowe' }, { 'no': 'et tak', 'pl': 'dach' }, { 'no': 'et game', 'pl': 'gra' }, { 'no': 'det er en del av gamet', 'pl': 'to część gry' }, { 'no': 'å forberede', 'pl': 'przygotować się' }, { 'no': 'å snu', 'pl': 'odwrócić, wrócić się' }, { 'no': 'en fase', 'pl': 'faza' }, { 'no': 'lykkes', 'pl': 'osiagnąć sukces' }, { 'no': 'eskalere', 'pl': 'zwiekszać' }, { 'no': 'en tiss', 'pl': 'penis, wagina' }, { 'no': 'et behov', 'pl': 'potrzeba, konieczność' }, { 'no': 'å grave ut', 'pl': 'wykopać' }, { 'no': 'eneste', 'pl': 'jedyny' }, { 'no': 'å varsle', 'pl': 'powiadomićc, ostrzec, zawiadomić' }, { 'no': 'et inntrykk', 'pl': 'wrażenie' }, { 'no': 'spiselig', 'pl': 'jadalny' }, { 'no': 'en kilde', 'pl': 'żrodło' }, { 'no': 'proteinkidle', 'pl': 'źrodło protein' }, { 'no': 'bærekraftig', 'pl': 'ekologiczny' }, { 'no': 'en gresshopper', 'pl': 'konik polny' }, { 'no': 'kina', 'pl': 'chiny' }, { 'no': 'et oppdrett', 'pl': 'hodowla' }, { 'no': 'å funke', 'pl': 'działać, funkcjonować' }, { 'no': 'absolutt', 'pl': 'absolutnie' }, { 'no': 'en galskap', 'pl': 'szaleństwo' }, { 'no': 'utilnæemelig', 'pl': 'niedostepny' }, { 'no': 'synlige', 'pl': 'widoczy' }, { 'no': 'lag på lag', 'pl': 'warstwa po warstwie' }, { 'no': 'å handle om', 'pl': 'zmierzyc sie z' }, { 'no': 'å sløse med penger', 'pl': 'strata pieniędzy' }, { 'no': 'å sløse med energi', 'pl': 'strata energii' }, { 'no': 'å sløse', 'pl': 'stracić' }, { 'no': 'en fortjeneste', 'pl': 'profit' }, { 'no': 'merkelig', 'pl': 'dziwne' }, { 'no': 'komplisert', 'pl': 'skomplikowane' }, { 'no': 'noe annet uansett', 'pl': 'w kazdym razie cos innego' }, { 'no': 'en grense', 'pl': 'granica' }, { 'no': 'underslå', 'pl': 'zdefraudować' }, { 'no': 'sokker', 'pl': 'skarpety' }, { 'no': 'å godta', 'pl': 'przejąc, zaakceptować' }, { 'no': 'skulle det rakne helt', 'pl': 'powinien calkowicie się ogolić' }, { 'no': 'en strupe', 'pl': 'gardło' }],


    [{ 'no': 'hjemmeværende', 'pl': 'gospodynia domowa' }, { 'no': 'utenfor', 'pl': 'na zewnątrz' }, { 'no': 'å gifte seg', 'pl': 'żenić się, wyjść za mąż' }, { 'no': 'senere', 'pl': 'później' }, { 'no': 'en deltidsjobb', 'pl': 'praca na połowę/część etatu' }, { 'no': 'en assistent', 'pl': 'asystent' }, { 'no': 'å foretrekke', 'pl': 'preferować' }, { 'no': 'å drive med', 'pl': 'zajmować się' }, { 'no': 'arbeidsledig', 'pl': 'bezrobotny' }, { 'no': 'en sjåfør', 'pl': 'szofer' }, { 'no': 'å glede seg til', 'pl': 'oczekiwać (look forward to)' }, { 'no': 'da jeg kom hit til landet', 'pl': 'kiedy przybyłem tu do kraju' }, { 'no': 'en byggeplass', 'pl': 'plac budowy' }, { 'no': 'en stund', 'pl': 'chwila' }, { 'no': 'å si opp', 'pl': 'zwolnić (kogoś z pracy), powiadomić, aulować' }, { 'no': 'dessverre', 'pl': 'niestety' }, { 'no': 'heldigvis', 'pl': 'szczęśliwie' }, { 'no': 'en vikarjobb', 'pl': 'praca na zastępstwie' }, { 'no': 'å slutte på', 'pl': 'rzucić' }, { 'no': 'forskjellige', 'pl': 'różne' }, { 'no': 'hva slags jobb vil du helst ha', 'pl': 'jaki rodzaj pracy wolałbyś mieć?' }, { 'no': 'å godkjenne godkjenner godkjente godkjent', 'pl': 'zdobyć nostryfikacje' }, { 'no': 'et behov', 'pl': 'potrzeba' }, { 'no': 'et behov for', 'pl': 'potrzeba na' }, { 'no': 'å ordne', 'pl': 'zaaranżować' }, { 'no': 'godkjenning av utdanningen', 'pl': 'nostryfikacja edukacji' }, { 'no': 'foreløpig', 'pl': 'wstępne, tymczasowe, obecne' }, { 'no': 'selvstendig', 'pl': 'samodzielny' }, { 'no': 'å være fornøyd med', 'pl': 'być zadowolonym z' }, { 'no': 'misfornøyd', 'pl': 'niezadowolony' }, { 'no': 'å ta seg av', 'pl': 'zajmować się (np. dziećmi)' }, { 'no': 'nok', 'pl': 'chyba, dość' }, { 'no': 'et lager', 'pl': 'magazyn' }, { 'no': 'en dommer', 'pl': 'sędzia' }, { 'no': 'å dømme', 'pl': 'sądzić' }, { 'no': 'farlig', 'pl': 'niebezpieczny' }, { 'no': 'ufarlig', 'pl': 'nie niebezpieczny' }, { 'no': 'en bonde', 'pl': 'rolnik' }, { 'no': 'en gris', 'pl': 'świnia' }, { 'no': 'å luke', 'pl': 'pielić' }, { 'no': 'tilfredsstillende', 'pl': 'zadowalający, satysfakcjonujący' }, { 'no': 'en tømmermann', 'pl': 'drwal' }, { 'no': 'en tømmerhugger', 'pl': 'drwal' }, { 'no': 'en/ei kilde', 'pl': 'źródło, studnia' }, { 'no': 'å mate', 'pl': 'karmić' }, { 'no': 'for tida, nå', 'pl': 'w tej chwili, teraz' }, { 'no': 'i noen år til', 'pl': 'przez kilka lat' }, { 'no': 'å se fram til', 'pl': 'nie móc się doczekać' }, { 'no': 'hva slags, hvilken type', 'pl': 'jakiego rodzaju' }, { 'no': 'siden', 'pl': 'od, później' }, { 'no': 'det tar lang tid', 'pl': 'to zajmuje dużo czasu' }, { 'no': 'å grue seg', 'pl': 'obawiać się, bać się' }, { 'no': 'en kjemi', 'pl': 'chemia' }, { 'no': 'en matematikk', 'pl': 'matematyka' }, { 'no': 'en teknologi', 'pl': 'technologia' }, { 'no': 'en oljeindustri', 'pl': 'przemysł naftowy' }, { 'no': 'en drømmejobb', 'pl': 'praca marzeń' }, { 'no': 'en drøm', 'pl': 'sen, marzenie' }, { 'no': 'å virke', 'pl': 'wydawać się' }, { 'no': 'en bransje', 'pl': 'branża, biznes' }, { 'no': 'en/ei inntekt', 'pl': 'dochód' }, { 'no': 'en grunn', 'pl': 'powód, przyczyna' }, { 'no': 'en/ei mulighet', 'pl': 'przyczyna' }, { 'no': 'jeg liker meg her', 'pl': 'podoba mi się tutaj' }, { 'no': 'en lege', 'pl': 'lekarz' }, { 'no': 'jammen på tide', 'pl': 'najwyższy czas' }, { 'no': 'å talle på', 'pl': 'zliczyć, zliczać' }, { 'no': 'en tilleggskurs', 'pl': 'kurs dodatkowy' }, { 'no': 'et tillegg', 'pl': 'dodatek' }, { 'no': 'å ordne seg', 'pl': 'ułożyło się' }, { 'no': 'en/ei ferdighet', 'pl': 'umiejętność' }],
]

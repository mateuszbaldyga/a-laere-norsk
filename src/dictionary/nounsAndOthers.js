const dict = [
    ...
    [{ 'no': 'å fortelle forteller fortalte har fortalt', 'pl': 'opowiadać' }, { 'no': 'å fortsette fortsetter fortsatte har fortsatt', 'pl': 'kontynuować' }, { 'no': 'å gjøre gjør gjorde har gjort', 'pl': 'robić' }, { 'no': 'å ha har hadde har hatt', 'pl': 'mieć' }, { 'no': 'å selge selger solgte har solgt', 'pl': 'sprzedać' }, { 'no': 'å sette setter satte har satt', 'pl': 'nastawić' }, { 'no': 'å spørre spør spurte har spurt', 'pl': 'pytać' }, { 'no': 'å velge velger valgte har valgt', 'pl': 'wybierać' }, { 'no': 'å vite vet visste har visst', 'pl': 'wiedzieć' }, { 'no': 'å be, ber, ba (el bad), har bedt', 'pl': 'zaprosić' }, { 'no': 'å bli blir ble har blitt', 'pl': 'pozostać' }, { 'no': 'å brekke brekker brakk har brukket', 'pl': 'złamać' }, { 'no': 'å dra drar dro har dratt', 'pl': 'jechać, ciągnąc' }, { 'no': 'å drikke drikker drakk har drukket', 'pl': 'pić' }, { 'no': 'å falle faller falt har falt', 'pl': 'upaść' }, { 'no': 'å finne finner fant har funnet', 'pl': 'znaleźć' }, { 'no': 'å forstå forstår forsto har forstått', 'pl': 'rozumieć' }, { 'no': 'å fryse fryser frøs har frosset', 'pl': 'marznąć' }, { 'no': 'å få får fikk har fått', 'pl': 'otrzymać' }, { 'no': 'å gi gir ga har gitt', 'pl': 'dać' }, { 'no': 'å gjenta gjentar gjentok har gjentatt', 'pl': 'powtarzać' }, { 'no': 'å gråte gråter gråt har grått', 'pl': 'płakać' }, { 'no': 'å gå går gikk har gått', 'pl': 'iść' }, { 'no': 'å hjelpe hjelper hjalp har hjulpet', 'pl': 'pomagać' }, { 'no': 'å holde holder holdt har holdt', 'pl': 'trzymać' }, { 'no': 'å komme kommer kom har kommet', 'pl': 'przychodzić' }, { 'no': 'å le ler lo har ledd', 'pl': 'smiać się' }, { 'no': 'å legge legger la har lagt', 'pl': 'kłaść' }, { 'no': 'å ligge ligger lå har ligget', 'pl': 'leżeć' }, { 'no': 'å løpe løper løp har løpt', 'pl': 'biegać' }, { 'no': 'å oppdra oppdrar oppdro har oppdratt', 'pl': 'wychować' }, { 'no': 'å overta overtar overtok har overtatt', 'pl': 'przejąć' }, { 'no': 'å se ser så har sett', 'pl': 'widzieć' }, { 'no': 'å si sier sa har sagt', 'pl': 'mówić' }, { 'no': 'å sitte sitter satt har sittet', 'pl': 'siedzieć' }, { 'no': 'å skjære skjærer skar har skåret', 'pl': 'kroić, obcinać' }, { 'no': 'å skrive skriver skrev har skrevet', 'pl': 'pisać' }, { 'no': 'å slippe slipper slapp har sluppet', 'pl': 'uniknąć, nie musieć czegoś robić' }, { 'no': 'å slå slår slo har slått', 'pl': 'uderzyć, zbić, ciąć, ścinać, kosić' }, { 'no': 'å synge synger sang har sunget', 'pl': 'śpiewać' }, { 'no': 'å ta tar tok har tatt', 'pl': 'brać' }, { 'no': 'å treffe treffer traff har truffet', 'pl': 'spotkać' }, { 'no': 'å være er var har vært', 'pl': 'być' }],

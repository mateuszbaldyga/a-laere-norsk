const dict = [
    ...
    [{ 'no': 'å drive med / å holde på med', 'pl': 'zajmować się' }, { 'no': 'et besøk', 'pl': 'odwiedziny, wizyta' }, { 'no': 'et hotell', 'pl': 'hotel' }, { 'no': 'å søke', 'pl': 'poszukiwać (seek, search)' }, { 'no': 'søke på en jobb', 'pl': 'apply for a job' }, { 'no': 'søke om studielån', 'pl': 'apply for a loan for one\'s studies' }, { 'no': 'en erfaring', 'pl': 'doświadczenie (experience)' }, { 'no': 'et regnskap', 'pl': 'rachunkowość' }, { 'no': 'et firma', 'pl': 'firma' }, { 'no': 'en utfordring', 'pl': 'wyzwanie (challenge)' }, { 'no': 'å ta førekort', 'pl': 'robić prawo jazdy' }, { 'no': 'kjøretimer', 'pl': 'jazdy próbne' }, { 'no': 'enig', 'pl': 'racja' }, { 'no': 'for en stund siden', 'pl': 'jakiś czas temu' }, { 'no': 'å sjekke', 'pl': 'sprawdzać, flirtować, czatować' }, { 'no': 'et nett', 'pl': 'sieć' }, { 'no': 'et tipse', 'pl': 'tip, wskazówka' }, { 'no': 'å savne', 'pl': 'tęsknić' }, { 'no': 'å glede seg over', 'pl': 'cieszyć się' }, { 'no': 'å glede seg til', 'pl': 'look forward to' }, { 'no': 'skål', 'pl': 'na zdrowie' }, { 'no': 'å oppfylle oppfyller oppfylte oppfylt', 'pl': 'spełniać' }, { 'no': 'søsken', 'pl': 'rodzeństwo' }, { 'no': 'en tvilling', 'pl': 'bliźniak' }, { 'no': 'en samtale', 'pl': 'rozmowa, conversation' }, { 'no': 'skilt skilte', 'pl': 'separated, divorced' }],
    ...
    [{"no":"borte fra jobben","pl":"z dala od pracy"},{"no":"vondt i ryggen","pl":"ból pleców"},{"no":"en rygg","pl":"plecy"},{"no":"å klare","pl":"zdołać, udać się (manage)"},{"no":"en kollega","pl":"kolega, współpracownik"},{"no":"kollega av monica","pl":"kolega moniki"},{"no":"stakkars deg","pl":"biedny ty (poor you)"},{"no":"å fylle seg","pl":"czuć się"},{"no":"å si fra til","pl":"przekazać"},{"no":"senere","pl":"później"},{"no":"like dårlig","pl":"tak samo źle"},{"no":"like","pl":"równy (equal)"},{"no":"kaster opp","pl":"wymiotować"},{"no":"å ta imot","pl":"otrzymać"},{"no":"et emne","pl":"temat"},{"no":"en sykdom, sykdommen","pl":"choroba"},{"no":"gi beskjed","pl":"dać znać"},{"no":"en feber","pl":"gorączka"}]
]
